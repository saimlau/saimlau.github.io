...
The App includes an optional "Scan Photo" feature that sends images to the Anthropic API for schedule recognition. This feature:
...
- Sends the image directly to Anthropic's servers — the App developer does not have access to these images
...
Apart from the optional Anthropic API integration described above, the App does not integrate with any third-party services, analytics, or advertising platforms.
